...
const ProductDetail =  {
    ...
    async render(){
        ...
        return `
                <form class="row" id="add-cart">
                <div class="col-6">
                    <img src="${product.image}"/>
                </div>
                <div class="col-6">
                    <h1 class="card-title" id="product-name">${product.name}</h1>  
                   ...
                   <hr>
                    <h6 class="h6">Chất liệu:  ${product.Material} </h6>
                    <input id="cart-amount" type="number" name="" value="1">
					<input type="submit" class="btn btn-primary" value="Thêm giỏ hàng"/>
